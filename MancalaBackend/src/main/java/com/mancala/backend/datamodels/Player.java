...
public class Player {
	...
	private List<MancalaPit> stonesInPit; //<pitId from constant, stonescount from Mancala pit class>
	...
	public Player(String playerName) {
		...
		if(playerName.equals("PlayerA")) {
			...
			this.stonesInPit = Arrays.asList(
	...
	public List<MancalaPit> getStonesInPit() {
		return stonesInPit;
	}
	public void setStonesInPit(List<MancalaPit> stonesInPit) {
